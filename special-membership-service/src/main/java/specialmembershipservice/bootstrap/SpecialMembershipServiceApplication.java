...
public class SpecialMembershipServiceApplication extends
    Application<SpecialMembershipServiceConfiguration> {

  @Override
  public void run(SpecialMembershipServiceConfiguration configuration, Environment environment)
      throws Exception {
    ObjectMapperConfig.applyTo(environment.getObjectMapper());
    registerResources(configuration, environment);
  }

  private void registerResources(SpecialMembershipServiceConfiguration configuration,
    ...
    environment.jersey()
        .register(new SpecialMembershipsResource(creditScoreService, eventPublisher));
  }
